...
/**
 * \file    test/phpunit/MMIProjectFunctionalTest.php
 * \ingroup mmiproject
...
/**
 * Class MMIProjectFunctionalTest
 *
 ...
 *
 * @package Testmmiproject
 */
class MMIProjectFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIProject')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIProject')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmiproject/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmiproject/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmiproject/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmiproject/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmiprojectwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIProject_MMIProjectTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIProject_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
