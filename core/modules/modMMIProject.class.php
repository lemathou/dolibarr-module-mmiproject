...
class modMMIProject extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$extrafields->addExtraField('status', $langs->trans('Extrafield_task_status'), 'select',  100,  3, 'projet_task',  0, 0, '', array('options'=>array('1'=>'Nouveau','2'=>'A faire','3'=>'En cours','4'=>'A corriger','9'=>'Fait / A vérifier','10'=>'Fermé')), 1,'', -1, $langs->trans('ExtrafieldToolTip_task_status'), '', $conf->entity, 'mmiproject@mmiproject', '$conf->mmiproject->enabled', 0);
		$extrafields->addExtraField('priority', $langs->trans('Extrafield_task_priority'), 'int',  100,  3, 'projet_task',  0, 0, '', '', 1,'', -1, $langs->trans('ExtrafieldToolTip_task_priority'), '', $conf->entity, 'mmiproject@mmiproject', '$conf->mmiproject->enabled', 0);
