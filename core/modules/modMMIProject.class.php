...
class modMMIProject extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$extrafields->addExtraField('fk_jalon_commandedet', $langs->trans('Extrafield_fk_jalon_commandedet'), 'sellist', 100, '', 'projet_task', 0, 0, '', "a:1:{s:7:\"options\";a:1:{s:25:\"commandedet:label:rowid::\";N;}}", 1, '', -5, $langs->trans('ExtrafieldToolTip_fk_jalon_commandedet'), '', $conf->entity, 'mmiproject@mmiproject', '$conf->mmiproject->enabled');
